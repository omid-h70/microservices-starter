...
type RideFare struct {
	...
	TotalPricesInCents float64                `protobuf:"fixed64,4,opt,name=total_prices_in_cents,json=totalPricesInCents,proto3" json:"total_prices_in_cents,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *RideFare) GetTotalPricesInCents() float64 {
	if x != nil {
		return x.TotalPricesInCents
	}
	return 0
}
...
func (x *CreateTripRequest) GetRoute() *Route {
	if x != nil {
		return x.Route
	}
	return nil
...
func (x *CreateTripRequest) GetRideFares() []*RideFare {
	if x != nil {
		return x.RideFares
	}
	return nil
...
func (x *CreateTripResponse) GetRideFares() []*RideFare {
	if x != nil {
		return x.RideFares
	}
	return nil
...
type Trip struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	SelectedFare  *RideFare              `protobuf:"bytes,2,opt,name=selected_fare,json=selectedFare,proto3" json:"selected_fare,omitempty"`
...
func (x *TripDriver) GetProfilePic() string {
	if x != nil {
		return x.ProfilePic
	}
	return ""
...
func (x *TripDriver) GetPlateNum() string {
	if x != nil {
		return x.PlateNum
	}
	return ""
...
const file_trip_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"trip.proto\x12\x04trip\"F\n" +
	"\n" +
	"Coordinate\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude\">\n" +
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"\x9b\x01\n" +
	...
	"\fend_location\x18\x03 \x01(\v2\x10.trip.CoordinateR\vendLocation\"k\n" +
	"\x05Route\x12\x1a\n" +
	"\bdistance\x18\x01 \x01(\x01R\bdistance\x12\x1a\n" +
	"\bduration\x18\x02 \x01(\x01R\bduration\x12*\n" +
	"\bgeometry\x18\x03 \x03(\v2\x0e.trip.GeometryR\bgeometry\"\x89\x01\n" +
	"\bRideFare\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12!\n" +
	"\fpackage_slug\x18\x03 \x01(\tR\vpackageSlug\x121\n" +
	"\x15total_prices_in_cents\x18\x04 \x01(\x01R\x12totalPricesInCents\"\x80\x01\n" +
	"\x13PreviewTripResponse\x12\x17\n" +
	"\atrip_id\x18\x01 \x01(\tR\x06tripId\x12!\n" +
	"\x05route\x18\x02 \x01(\v2\v.trip.RouteR\x05route\x12-\n" +
	"\n" +
	"ride_fares\x18\x03 \x03(\v2\x0e.trip.RideFareR\trideFares\"~\n" +
	"\x11CreateTripRequest\x12\x17\n" +
	"\atrip_id\x18\x01 \x01(\tR\x06tripId\x12!\n" +
	"\x05route\x18\x02 \x01(\v2\v.trip.RouteR\x05route\x12-\n" +
	"\n" +
	"ride_fares\x18\x03 \x03(\v2\x0e.trip.RideFareR\trideFares\"\x7f\n" +
	"\x12CreateTripResponse\x12\x17\n" +
	"\atrip_id\x18\x01 \x01(\tR\x06tripId\x12!\n" +
	"\x05route\x18\x02 \x01(\v2\v.trip.RouteR\x05route\x12-\n" +
	"\n" +
	"ride_fares\x18\x03 \x03(\v2\x0e.trip.RideFareR\trideFares\"\xc9\x01\n" +
	"\x04Trip\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x123\n" +
	"\rselected_fare\x18\x02 \x01(\v2\x0e.trip.RideFareR\fselectedFare\x12!\n" +
...
var file_trip_proto_goTypes = []any{
	(*Coordinate)(nil),          // 0: trip.Coordinate
	(*Geometry)(nil),            // 1: trip.Geometry
	(*PreviewTripRequest)(nil),  // 2: trip.PreviewTripRequest
	(*Route)(nil),               // 3: trip.Route
	(*RideFare)(nil),            // 4: trip.RideFare
	(*PreviewTripResponse)(nil), // 5: trip.PreviewTripResponse
...
var file_trip_proto_depIdxs = []int32{
	0,  // 0: trip.Geometry.coordinates:type_name -> trip.Coordinate
	0,  // 1: trip.PreviewTripRequest.start_location:type_name -> trip.Coordinate
	0,  // 2: trip.PreviewTripRequest.end_location:type_name -> trip.Coordinate
	1,  // 3: trip.Route.geometry:type_name -> trip.Geometry
	3,  // 4: trip.PreviewTripResponse.route:type_name -> trip.Route
	4,  // 5: trip.PreviewTripResponse.ride_fares:type_name -> trip.RideFare
	3,  // 6: trip.CreateTripRequest.route:type_name -> trip.Route
	4,  // 7: trip.CreateTripRequest.ride_fares:type_name -> trip.RideFare
	3,  // 8: trip.CreateTripResponse.route:type_name -> trip.Route
	4,  // 9: trip.CreateTripResponse.ride_fares:type_name -> trip.RideFare
	4,  // 10: trip.Trip.selected_fare:type_name -> trip.RideFare
	3,  // 11: trip.Trip.route:type_name -> trip.Route
	9,  // 12: trip.Trip.driver:type_name -> trip.TripDriver
	6,  // 13: trip.TripService.CreateTrip:input_type -> trip.CreateTripRequest
	2,  // 14: trip.TripService.PreviewTrip:input_type -> trip.PreviewTripRequest
	7,  // 15: trip.TripService.CreateTrip:output_type -> trip.CreateTripResponse
	5,  // 16: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
